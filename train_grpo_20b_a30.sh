#!/usr/bin/env bash
# GRPO training for gpt-oss-20b — Attempt 30 (micro_train_batch_size=2)
#
# SINGLE-VARIABLE EXPERIMENT: micro_train_batch_size comparison vs A29B.
#   A29B: micro_train_batch_size=1 (baseline, eps_clip=0.1)
#   A30:  micro_train_batch_size=2
#
# CHANGES FROM A29B:
...
echo "=== GRPO Training — Attempt 30 (gpt-oss-20b, micro_train_batch_size=2) ==="
...
echo ""
echo "  ★ micro_train_batch_size=2 (vs 1 in A29B)"
echo "  ★ eps_clip=0.1 (new default from A29 A/B comparison)"
